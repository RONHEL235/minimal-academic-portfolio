      ...
      <section className="space-y-12">
        {[...Array(4)].map((_, index) => (
          ...
          >
            ...
            >
              {/* IMAGE PLACEHOLDER */}
              <div className="w-full md:w-64 h-40 border dark:bg-neutral-900 dark:text-neutral-600 flex items-center justify-center text-neutral-600 text-sm shrink-0">
                Project Preview
              </div>
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="max-w-2xl text-neutral-700 dark:text-neutral-400">
